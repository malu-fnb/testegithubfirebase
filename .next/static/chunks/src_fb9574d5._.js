...
function CampusGateApp() {
    ...
    const isValidBrazilianPlate = (plate)=>{
        const normalizedPlate = normalizePlate(plate);
        const oldPlatePattern = /^[A-Z]{3}[0-9]{4}$/;
        const mercosulPlatePattern = /^[A-Z]{3}[0-9][A-Z][0-9]{2}$/;
        return oldPlatePattern.test(normalizedPlate) || mercosulPlatePattern.test(normalizedPlate);
    };
    const handleAddVehicle = ()=>{
        ...
        if (!isValidBrazilianPlate(normalizedPlate)) {
            toast({
                ...
                description: "Use o padrão antigo ABC1234 ou o padrão Mercosul ABC1D23."
            });
            return;
        }
        ...
        const plateAlreadyExists = vehicles.some((v)=>normalizePlate(v.plate) === normalizedPlate);
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                        className: "text-[10px] text-muted-foreground italic",
                                                        children: "A validação oficial da placa é feita pelo backend."
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/page.tsx",
                                                        lineNumber: 668,
                                                        columnNumber: 25
...
_s(CampusGateApp, "QvT9yPGeGlfO3HitcN6Soj3jUng=", false, function() {
    return [
...
//# sourceMappingURL=src_fb9574d5._.js.map